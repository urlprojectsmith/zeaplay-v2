...
export function PlatformGlobalLeaderboardPage() {
  ...
  const agenciesQuery = useQuery({
    ...
    enabled: Boolean(accessToken && selectedAgencyId && activeTab === 'agencies'),
  });
  const subaccountsQuery = useQuery({
    ...
    enabled: Boolean(accessToken && selectedAgencyId && activeTab === 'subaccounts'),
  });
  const usersQuery = useQuery({
    queryKey: globalGamificationKeys.platform(selectedAgencyId, 'users', params),
    queryFn: () => getPlatformGlobalUsers(params),
    enabled: Boolean(accessToken && selectedAgencyId && activeTab === 'users'),
  });
